      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <Link to={`/edit/${this.state.contact._id}`} class="btn btn-success">Edit</Link>&nbsp;
            <button onClick={this.delete.bind(this, this.state.contact._id)} class="btn btn-danger">Delete</button>
          </div>
        </div>
      </div>
    );
