...
class Edit extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios.put('/api/contacts/'+this.props.match.params.id, { name, address, city, postalCode, phone, email })
      .then((result) => {
      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h4><Link to={`/show/${this.state.contact._id}`}><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Contact List</Link></h4>
